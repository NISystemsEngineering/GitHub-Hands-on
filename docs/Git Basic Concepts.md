...
2. Fill out the fields for the new repository to be created.
	...
	4. Most software project require documentation, and the easiest place to do that in GitHub is in the README.md file. If you want to create this file when you create repository, check the box.
	...
	9. Go to your GitHub page online and observe the files that were created.
